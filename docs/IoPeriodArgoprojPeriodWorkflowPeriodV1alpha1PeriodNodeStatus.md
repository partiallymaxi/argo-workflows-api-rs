...
**memoization_status** | Option<[**models::IoPeriodArgoprojPeriodWorkflowPeriodV1alpha1PeriodMemoizationStatus**](io.argoproj.workflow.v1alpha1.MemoizationStatus.md)> |  | [optional]
...
**node_flag** | Option<[**models::IoPeriodArgoprojPeriodWorkflowPeriodV1alpha1PeriodNodeFlag**](io.argoproj.workflow.v1alpha1.NodeFlag.md)> |  | [optional]
...
**synchronization_status** | Option<[**models::IoPeriodArgoprojPeriodWorkflowPeriodV1alpha1PeriodNodeSynchronizationStatus**](io.argoproj.workflow.v1alpha1.NodeSynchronizationStatus.md)> |  | [optional]
**task_result_synced** | Option<**bool**> | TaskResultSynced is used to determine if the node's output has been received | [optional]
