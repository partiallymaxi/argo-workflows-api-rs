...
> models::GithubPeriodComPeriodArgoprojPeriodArgoEventsPeriodPkgPeriodApisPeriodEventsPeriodV1alpha1PeriodSensor sensor_service_create_sensor(namespace, body)
...
**body** | [**SensorPeriodCreateSensorRequest**](SensorPeriodCreateSensorRequest.md) |  | [required] |

### Return type

[**models::GithubPeriodComPeriodArgoprojPeriodArgoEventsPeriodPkgPeriodApisPeriodEventsPeriodV1alpha1PeriodSensor**](github.com.argoproj.argo_events.pkg.apis.events.v1alpha1.Sensor.md)
...
> models::GithubPeriodComPeriodArgoprojPeriodArgoEventsPeriodPkgPeriodApisPeriodEventsPeriodV1alpha1PeriodSensor sensor_service_get_sensor(namespace, name, get_options_period_resource_version)
...
[**models::GithubPeriodComPeriodArgoprojPeriodArgoEventsPeriodPkgPeriodApisPeriodEventsPeriodV1alpha1PeriodSensorList**](github.com.argoproj.argo_events.pkg.apis.events.v1alpha1.SensorList.md)
...
------------- | ------------- | ------------- | ------------- | -------------
**namespace** | **String** |  | [required] |
**name** | Option<**String**> | optional - only return entries for this sensor name. |  |
**trigger_name** | Option<**String**> | optional - only return entries for this trigger. |  |
**grep** | Option<**String**> | option - only return entries where `msg` contains this regular expressions. |  |
...
[**models::StreamResultOfSensorLogEntry**](Stream_result_of_sensor_LogEntry.md)
...
> models::GithubPeriodComPeriodArgoprojPeriodArgoEventsPeriodPkgPeriodApisPeriodEventsPeriodV1alpha1PeriodSensor sensor_service_update_sensor(namespace, name, body)
...
**namespace** | **String** |  | [required] |
**name** | **String** |  | [required] |
**body** | [**SensorPeriodUpdateSensorRequest**](SensorPeriodUpdateSensorRequest.md) |  | [required] |
...
> models::StreamResultOfSensorSensorWatchEvent sensor_service_watch_sensors(namespace, list_options_period_label_selector, list_options_period_field_selector, list_options_period_watch, list_options_period_allow_watch_bookmarks, list_options_period_resource_version, list_options_period_resource_version_match, list_options_period_timeout_seconds, list_options_period_limit, list_options_period_continue, list_options_period_send_initial_events)
...
[**models::StreamResultOfSensorSensorWatchEvent**](Stream_result_of_sensor_SensorWatchEvent.md)
