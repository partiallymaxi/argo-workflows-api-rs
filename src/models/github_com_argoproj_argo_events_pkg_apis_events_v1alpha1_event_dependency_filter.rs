...
/// GithubComArgoprojArgoEventsPkgApisEventsV1alpha1EventDependencyFilter : EventDependencyFilter defines filters and constraints for a io.argoproj.workflow.v1alpha1.
#[derive(Clone, Default, Debug, PartialEq, Serialize, Deserialize)]
pub struct GithubComArgoprojArgoEventsPkgApisEventsV1alpha1EventDependencyFilter {
    #[serde(rename = "context", skip_serializing_if = "Option::is_none")]
    pub context: Option<Box<models::GithubComArgoprojArgoEventsPkgApisEventsV1alpha1EventContext>>,
    #[serde(rename = "data", skip_serializing_if = "Option::is_none")]
    pub data: Option<Vec<models::GithubComArgoprojArgoEventsPkgApisEventsV1alpha1DataFilter>>,
    ...
    pub exprs: Option<Vec<models::GithubComArgoprojArgoEventsPkgApisEventsV1alpha1ExprFilter>>,
    ...
    pub time: Option<Box<models::GithubComArgoprojArgoEventsPkgApisEventsV1alpha1TimeFilter>>,
}

impl GithubComArgoprojArgoEventsPkgApisEventsV1alpha1EventDependencyFilter {
    /// EventDependencyFilter defines filters and constraints for a io.argoproj.workflow.v1alpha1.
    pub fn new() -> GithubComArgoprojArgoEventsPkgApisEventsV1alpha1EventDependencyFilter {
