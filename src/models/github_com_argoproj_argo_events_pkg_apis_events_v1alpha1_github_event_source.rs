...
pub struct GithubComArgoprojArgoEventsPkgApisEventsV1alpha1GithubEventSource {
    #[serde(rename = "active", skip_serializing_if = "Option::is_none")]
    pub active: Option<bool>,
    #[serde(rename = "apiToken", skip_serializing_if = "Option::is_none")]
    pub api_token: Option<Box<models::IoK8sApiCoreV1SecretKeySelector>>,
    ...
    pub github_app: Option<Box<models::GithubComArgoprojArgoEventsPkgApisEventsV1alpha1GithubAppCreds>>,
    ...
    pub repositories: Option<Vec<models::GithubComArgoprojArgoEventsPkgApisEventsV1alpha1OwnedRepositories>>,
...
impl GithubComArgoprojArgoEventsPkgApisEventsV1alpha1GithubEventSource {
    pub fn new() -> GithubComArgoprojArgoEventsPkgApisEventsV1alpha1GithubEventSource {
