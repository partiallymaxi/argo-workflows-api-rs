...
pub struct GithubComArgoprojArgoEventsPkgApisEventsV1alpha1KafkaEventSource {
    ...
    pub consumer_group: Option<Box<models::GithubComArgoprojArgoEventsPkgApisEventsV1alpha1KafkaConsumerGroup>>,
...
impl GithubComArgoprojArgoEventsPkgApisEventsV1alpha1KafkaEventSource {
    pub fn new() -> GithubComArgoprojArgoEventsPkgApisEventsV1alpha1KafkaEventSource {
