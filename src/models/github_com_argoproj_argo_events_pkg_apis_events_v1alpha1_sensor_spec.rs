...
pub struct GithubComArgoprojArgoEventsPkgApisEventsV1alpha1SensorSpec {
    /// Dependencies is a list of the events that this sensor is dependent on.
    #[serde(rename = "dependencies", skip_serializing_if = "Option::is_none")]
    pub dependencies: Option<Vec<models::GithubComArgoprojArgoEventsPkgApisEventsV1alpha1EventDependency>>,
    ...
    pub triggers: Option<Vec<models::GithubComArgoprojArgoEventsPkgApisEventsV1alpha1Trigger>>,
}

impl GithubComArgoprojArgoEventsPkgApisEventsV1alpha1SensorSpec {
    pub fn new() -> GithubComArgoprojArgoEventsPkgApisEventsV1alpha1SensorSpec {
