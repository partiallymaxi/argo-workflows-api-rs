...
pub struct GithubComArgoprojArgoEventsPkgApisEventsV1alpha1SqsEventSource {
    ...
    pub session_token: Option<Box<models::IoK8sApiCoreV1SecretKeySelector>>,
...
impl GithubComArgoprojArgoEventsPkgApisEventsV1alpha1SqsEventSource {
    pub fn new() -> GithubComArgoprojArgoEventsPkgApisEventsV1alpha1SqsEventSource {
