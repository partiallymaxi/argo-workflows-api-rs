...
pub struct IoArgoprojWorkflowV1alpha1Artifact {
    ...
    pub archive: Option<Box<models::IoArgoprojWorkflowV1alpha1ArchiveStrategy>>,
    ...
    pub artifact_gc: Option<Box<models::IoArgoprojWorkflowV1alpha1ArtifactGc>>,
    #[serde(rename = "artifactory", skip_serializing_if = "Option::is_none")]
    pub artifactory: Option<Box<models::IoArgoprojWorkflowV1alpha1ArtifactoryArtifact>>,
    #[serde(rename = "azure", skip_serializing_if = "Option::is_none")]
    pub azure: Option<Box<models::IoArgoprojWorkflowV1alpha1AzureArtifact>>,
    ...
    pub gcs: Option<Box<models::IoArgoprojWorkflowV1alpha1GcsArtifact>>,
    #[serde(rename = "git", skip_serializing_if = "Option::is_none")]
    pub git: Option<Box<models::IoArgoprojWorkflowV1alpha1GitArtifact>>,
    ...
    pub hdfs: Option<Box<models::IoArgoprojWorkflowV1alpha1HdfsArtifact>>,
    #[serde(rename = "http", skip_serializing_if = "Option::is_none")]
    pub http: Option<Box<models::IoArgoprojWorkflowV1alpha1HttpArtifact>>,
    ...
    pub oss: Option<Box<models::IoArgoprojWorkflowV1alpha1OssArtifact>>,
    /// Path is the container path to the artifact
    #[serde(rename = "path", skip_serializing_if = "Option::is_none")]
    pub path: Option<String>,
    #[serde(rename = "raw", skip_serializing_if = "Option::is_none")]
    pub raw: Option<Box<models::IoArgoprojWorkflowV1alpha1RawArtifact>>,
    ...
    pub s3: Option<Box<models::IoArgoprojWorkflowV1alpha1S3Artifact>>,
    /// SubPath allows an artifact to be sourced from a subpath within the specified source
    #[serde(rename = "subPath", skip_serializing_if = "Option::is_none")]
    pub sub_path: Option<String>,
}

impl IoArgoprojWorkflowV1alpha1Artifact {
    /// Artifact indicates an artifact to place at a specified path
    pub fn new(name: String) -> IoArgoprojWorkflowV1alpha1Artifact {
