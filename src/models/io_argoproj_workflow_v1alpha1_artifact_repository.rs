...
pub struct IoArgoprojWorkflowV1alpha1ArtifactRepository {
    ...
    pub artifactory: Option<Box<models::IoArgoprojWorkflowV1alpha1ArtifactoryArtifactRepository>>,
    #[serde(rename = "azure", skip_serializing_if = "Option::is_none")]
    pub azure: Option<Box<models::IoArgoprojWorkflowV1alpha1AzureArtifactRepository>>,
    #[serde(rename = "gcs", skip_serializing_if = "Option::is_none")]
    pub gcs: Option<Box<models::IoArgoprojWorkflowV1alpha1GcsArtifactRepository>>,
    #[serde(rename = "hdfs", skip_serializing_if = "Option::is_none")]
    pub hdfs: Option<Box<models::IoArgoprojWorkflowV1alpha1HdfsArtifactRepository>>,
    #[serde(rename = "oss", skip_serializing_if = "Option::is_none")]
    pub oss: Option<Box<models::IoArgoprojWorkflowV1alpha1OssArtifactRepository>>,
    #[serde(rename = "s3", skip_serializing_if = "Option::is_none")]
    pub s3: Option<Box<models::IoArgoprojWorkflowV1alpha1S3ArtifactRepository>>,
}
