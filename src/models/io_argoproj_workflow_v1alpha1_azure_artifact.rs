...
/// IoArgoprojWorkflowV1alpha1AzureArtifact : AzureArtifact is the location of an Azure Storage artifact
...
pub struct IoArgoprojWorkflowV1alpha1AzureArtifact {
    ...
    pub account_key_secret: Option<Box<models::IoK8sApiCoreV1SecretKeySelector>>,
