...
impl IoArgoprojWorkflowV1alpha1ClusterWorkflowTemplate {
    /// ClusterWorkflowTemplate is the definition of a workflow template resource in cluster scope
    pub fn new(metadata: models::IoK8sApimachineryPkgApisMetaV1ObjectMeta, spec: models::IoArgoprojWorkflowV1alpha1WorkflowSpec) -> IoArgoprojWorkflowV1alpha1ClusterWorkflowTemplate {
