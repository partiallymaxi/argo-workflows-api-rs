...
pub struct IoArgoprojWorkflowV1alpha1ClusterWorkflowTemplateList {
    ...
    #[serde(rename = "items")]
    pub items: Vec<models::IoArgoprojWorkflowV1alpha1ClusterWorkflowTemplate>,
...
impl IoArgoprojWorkflowV1alpha1ClusterWorkflowTemplateList {
    /// ClusterWorkflowTemplateList is list of ClusterWorkflowTemplate resources
    pub fn new(items: Vec<models::IoArgoprojWorkflowV1alpha1ClusterWorkflowTemplate>, metadata: models::IoK8sApimachineryPkgApisMetaV1ListMeta) -> IoArgoprojWorkflowV1alpha1ClusterWorkflowTemplateList {
