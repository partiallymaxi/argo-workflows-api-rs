...
pub struct IoArgoprojWorkflowV1alpha1CronWorkflow {
    ...
    #[serde(rename = "spec")]
    pub spec: Box<models::IoArgoprojWorkflowV1alpha1CronWorkflowSpec>,
    #[serde(rename = "status", skip_serializing_if = "Option::is_none")]
    pub status: Option<Box<models::IoArgoprojWorkflowV1alpha1CronWorkflowStatus>>,
}

impl IoArgoprojWorkflowV1alpha1CronWorkflow {
    /// CronWorkflow is the definition of a scheduled workflow resource
    pub fn new(metadata: models::IoK8sApimachineryPkgApisMetaV1ObjectMeta, spec: models::IoArgoprojWorkflowV1alpha1CronWorkflowSpec) -> IoArgoprojWorkflowV1alpha1CronWorkflow {
