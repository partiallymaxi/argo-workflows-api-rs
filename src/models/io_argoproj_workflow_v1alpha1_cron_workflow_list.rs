...
pub struct IoArgoprojWorkflowV1alpha1CronWorkflowList {
    ...
    #[serde(rename = "items")]
    pub items: Vec<models::IoArgoprojWorkflowV1alpha1CronWorkflow>,
...
impl IoArgoprojWorkflowV1alpha1CronWorkflowList {
    ...
    pub fn new(items: Vec<models::IoArgoprojWorkflowV1alpha1CronWorkflow>, metadata: models::IoK8sApimachineryPkgApisMetaV1ListMeta) -> IoArgoprojWorkflowV1alpha1CronWorkflowList {
