...
pub struct IoArgoprojWorkflowV1alpha1CronWorkflowSpec {
    ...
    pub stop_strategy: Option<Box<models::IoArgoprojWorkflowV1alpha1StopStrategy>>,
    ...
    pub workflow_metadata: Option<Box<models::IoK8sApimachineryPkgApisMetaV1ObjectMeta>>,
    #[serde(rename = "workflowSpec")]
    pub workflow_spec: Box<models::IoArgoprojWorkflowV1alpha1WorkflowSpec>,
}

impl IoArgoprojWorkflowV1alpha1CronWorkflowSpec {
    /// CronWorkflowSpec is the specification of a CronWorkflow
    pub fn new(workflow_spec: models::IoArgoprojWorkflowV1alpha1WorkflowSpec) -> IoArgoprojWorkflowV1alpha1CronWorkflowSpec {
