...
pub struct IoArgoprojWorkflowV1alpha1DagTask {
    ...
    pub continue_on: Option<Box<models::IoArgoprojWorkflowV1alpha1ContinueOn>>,
    ...
    pub inline: Option<Box<models::IoArgoprojWorkflowV1alpha1Template>>,
    ...
    pub with_sequence: Option<Box<models::IoArgoprojWorkflowV1alpha1Sequence>>,
}
