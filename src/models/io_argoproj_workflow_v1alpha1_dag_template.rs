...
pub struct IoArgoprojWorkflowV1alpha1DagTemplate {
    ...
    #[serde(rename = "tasks")]
    pub tasks: Vec<models::IoArgoprojWorkflowV1alpha1DagTask>,
}

impl IoArgoprojWorkflowV1alpha1DagTemplate {
    /// DAGTemplate is a template subtype for directed acyclic graph templates
    pub fn new(tasks: Vec<models::IoArgoprojWorkflowV1alpha1DagTask>) -> IoArgoprojWorkflowV1alpha1DagTemplate {
