...
pub struct IoArgoprojWorkflowV1alpha1Memoize {
    #[serde(rename = "cache")]
    pub cache: Box<models::IoArgoprojWorkflowV1alpha1Cache>,
...
impl IoArgoprojWorkflowV1alpha1Memoize {
    ...
    pub fn new(cache: models::IoArgoprojWorkflowV1alpha1Cache, key: String, max_age: String) -> IoArgoprojWorkflowV1alpha1Memoize {
