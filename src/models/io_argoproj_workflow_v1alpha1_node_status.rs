...
pub struct IoArgoprojWorkflowV1alpha1NodeStatus {
    ...
    pub memoization_status: Option<Box<models::IoArgoprojWorkflowV1alpha1MemoizationStatus>>,
    ...
    pub node_flag: Option<Box<models::IoArgoprojWorkflowV1alpha1NodeFlag>>,
    ...
    pub synchronization_status: Option<Box<models::IoArgoprojWorkflowV1alpha1NodeSynchronizationStatus>>,
    /// TaskResultSynced is used to determine if the node's output has been received
    #[serde(rename = "taskResultSynced", skip_serializing_if = "Option::is_none")]
    pub task_result_synced: Option<bool>,
...
impl IoArgoprojWorkflowV1alpha1NodeStatus {
    ...
    pub fn new(id: String, name: String, r#type: String) -> IoArgoprojWorkflowV1alpha1NodeStatus {
