...
pub struct IoArgoprojWorkflowV1alpha1OAuth2Auth {
    ...
    pub client_id_secret: Option<Box<models::IoK8sApiCoreV1SecretKeySelector>>,
    #[serde(rename = "clientSecretSecret", skip_serializing_if = "Option::is_none")]
    pub client_secret_secret: Option<Box<models::IoK8sApiCoreV1SecretKeySelector>>,
    #[serde(rename = "endpointParams", skip_serializing_if = "Option::is_none")]
    pub endpoint_params: Option<Vec<models::IoArgoprojWorkflowV1alpha1OAuth2EndpointParam>>,
    #[serde(rename = "scopes", skip_serializing_if = "Option::is_none")]
    pub scopes: Option<Vec<String>>,
    #[serde(rename = "tokenURLSecret", skip_serializing_if = "Option::is_none")]
    pub token_url_secret: Option<Box<models::IoK8sApiCoreV1SecretKeySelector>>,
}
