...
pub struct IoArgoprojWorkflowV1alpha1OssArtifactRepository {
    ...
    pub lifecycle_rule: Option<Box<models::IoArgoprojWorkflowV1alpha1OssLifecycleRule>>,
...
impl IoArgoprojWorkflowV1alpha1OssArtifactRepository {
    /// OSSArtifactRepository defines the controller configuration for an OSS artifact repository
    pub fn new() -> IoArgoprojWorkflowV1alpha1OssArtifactRepository {
