...
pub struct IoArgoprojWorkflowV1alpha1Prometheus {
    ...
    pub counter: Option<Box<models::IoArgoprojWorkflowV1alpha1Counter>>,
    #[serde(rename = "gauge", skip_serializing_if = "Option::is_none")]
    pub gauge: Option<Box<models::IoArgoprojWorkflowV1alpha1Gauge>>,
    /// Help is a string that describes the metric
    #[serde(rename = "help")]
    pub help: String,
    #[serde(rename = "histogram", skip_serializing_if = "Option::is_none")]
    pub histogram: Option<Box<models::IoArgoprojWorkflowV1alpha1Histogram>>,
    /// Labels is a list of metric labels
    #[serde(rename = "labels", skip_serializing_if = "Option::is_none")]
    pub labels: Option<Vec<models::IoArgoprojWorkflowV1alpha1MetricLabel>>,
