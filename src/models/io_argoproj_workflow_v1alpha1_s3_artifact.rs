...
pub struct IoArgoprojWorkflowV1alpha1S3Artifact {
    ...
    pub access_key_secret: Option<Box<models::IoK8sApiCoreV1SecretKeySelector>>,
    /// Bucket is the name of the bucket
    #[serde(rename = "bucket", skip_serializing_if = "Option::is_none")]
    pub bucket: Option<String>,
    #[serde(rename = "caSecret", skip_serializing_if = "Option::is_none")]
    pub ca_secret: Option<Box<models::IoK8sApiCoreV1SecretKeySelector>>,
    #[serde(rename = "createBucketIfNotPresent", skip_serializing_if = "Option::is_none")]
    pub create_bucket_if_not_present: Option<Box<models::IoArgoprojWorkflowV1alpha1CreateS3BucketOptions>>,
    #[serde(rename = "encryptionOptions", skip_serializing_if = "Option::is_none")]
    pub encryption_options: Option<Box<models::IoArgoprojWorkflowV1alpha1S3EncryptionOptions>>,
    ...
    pub secret_key_secret: Option<Box<models::IoK8sApiCoreV1SecretKeySelector>>,
    #[serde(rename = "sessionTokenSecret", skip_serializing_if = "Option::is_none")]
    pub session_token_secret: Option<Box<models::IoK8sApiCoreV1SecretKeySelector>>,
