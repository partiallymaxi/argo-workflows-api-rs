...
pub struct IoArgoprojWorkflowV1alpha1WorkflowSpec {
    ...
    pub artifact_gc: Option<Box<models::IoArgoprojWorkflowV1alpha1WorkflowLevelArtifactGc>>,
    #[serde(rename = "artifactRepositoryRef", skip_serializing_if = "Option::is_none")]
    pub artifact_repository_ref: Option<Box<models::IoArgoprojWorkflowV1alpha1ArtifactRepositoryRef>>,
    ...
    pub dns_config: Option<Box<models::IoK8sApiCoreV1PodDnsConfig>>,
    ...
    pub hooks: Option<std::collections::HashMap<String, models::IoArgoprojWorkflowV1alpha1LifecycleHook>>,
    ...
    pub pod_disruption_budget: Option<Box<models::IoK8sApiPolicyV1PodDisruptionBudgetSpec>>,
    #[serde(rename = "podGC", skip_serializing_if = "Option::is_none")]
    pub pod_gc: Option<Box<models::IoArgoprojWorkflowV1alpha1PodGc>>,
    ...
    pub template_defaults: Option<Box<models::IoArgoprojWorkflowV1alpha1Template>>,
    /// Templates is a list of workflow templates used in a workflow
    #[serde(rename = "templates", skip_serializing_if = "Option::is_none")]
    pub templates: Option<Vec<models::IoArgoprojWorkflowV1alpha1Template>>,
    ...
    pub ttl_strategy: Option<Box<models::IoArgoprojWorkflowV1alpha1TtlStrategy>>,
    #[serde(rename = "volumeClaimGC", skip_serializing_if = "Option::is_none")]
    pub volume_claim_gc: Option<Box<models::IoArgoprojWorkflowV1alpha1VolumeClaimGc>>,
    /// VolumeClaimTemplates is a list of claims that containers are allowed to reference. The Workflow controller will create the claims at the beginning of the workflow and delete the claims upon completion of the workflow
    #[serde(rename = "volumeClaimTemplates", skip_serializing_if = "Option::is_none")]
    pub volume_claim_templates: Option<Vec<models::IoK8sApiCoreV1PersistentVolumeClaim>>,
    ...
    pub workflow_metadata: Option<Box<models::IoArgoprojWorkflowV1alpha1WorkflowMetadata>>,
    #[serde(rename = "workflowTemplateRef", skip_serializing_if = "Option::is_none")]
    pub workflow_template_ref: Option<Box<models::IoArgoprojWorkflowV1alpha1WorkflowTemplateRef>>,
}
