...
pub struct IoArgoprojWorkflowV1alpha1WorkflowStatus {
    ...
    pub artifact_gc_status: Option<Box<models::IoArgoprojWorkflowV1alpha1ArtGcStatus>>,
    #[serde(rename = "artifactRepositoryRef", skip_serializing_if = "Option::is_none")]
    pub artifact_repository_ref: Option<Box<models::IoArgoprojWorkflowV1alpha1ArtifactRepositoryRefStatus>>,
    ...
    pub nodes: Option<std::collections::HashMap<String, models::IoArgoprojWorkflowV1alpha1NodeStatus>>,
    ...
    pub persistent_volume_claims: Option<Vec<models::IoK8sApiCoreV1Volume>>,
    ...
    pub stored_templates: Option<std::collections::HashMap<String, models::IoArgoprojWorkflowV1alpha1Template>>,
    #[serde(rename = "storedWorkflowTemplateSpec", skip_serializing_if = "Option::is_none")]
    pub stored_workflow_template_spec: Option<Box<models::IoArgoprojWorkflowV1alpha1WorkflowSpec>>,
    #[serde(rename = "synchronization", skip_serializing_if = "Option::is_none")]
    pub synchronization: Option<Box<models::IoArgoprojWorkflowV1alpha1SynchronizationStatus>>,
