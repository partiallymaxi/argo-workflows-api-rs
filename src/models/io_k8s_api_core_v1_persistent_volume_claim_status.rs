...
pub struct IoK8sApiCoreV1PersistentVolumeClaimStatus {
    ...
    pub conditions: Option<Vec<models::IoK8sApiCoreV1PersistentVolumeClaimCondition>>,
    ...
    pub modify_volume_status: Option<Box<models::IoK8sApiCoreV1ModifyVolumeStatus>>,
