...
pub struct IoK8sApiCoreV1PodAntiAffinity {
    ...
    pub preferred_during_scheduling_ignored_during_execution: Option<Vec<models::IoK8sApiCoreV1WeightedPodAffinityTerm>>,
    ...
    pub required_during_scheduling_ignored_during_execution: Option<Vec<models::IoK8sApiCoreV1PodAffinityTerm>>,
}

impl IoK8sApiCoreV1PodAntiAffinity {
    /// Pod anti affinity is a group of inter pod anti affinity scheduling rules.
    pub fn new() -> IoK8sApiCoreV1PodAntiAffinity {
