...
pub struct IoK8sApiCoreV1PodSecurityContext {
    ...
    pub app_armor_profile: Option<Box<models::IoK8sApiCoreV1AppArmorProfile>>,
    ...
    pub se_linux_options: Option<Box<models::IoK8sApiCoreV1SeLinuxOptions>>,
    #[serde(rename = "seccompProfile", skip_serializing_if = "Option::is_none")]
    pub seccomp_profile: Option<Box<models::IoK8sApiCoreV1SeccompProfile>>,
    ...
    pub sysctls: Option<Vec<models::IoK8sApiCoreV1Sysctl>>,
    #[serde(rename = "windowsOptions", skip_serializing_if = "Option::is_none")]
    pub windows_options: Option<Box<models::IoK8sApiCoreV1WindowsSecurityContextOptions>>,
}
