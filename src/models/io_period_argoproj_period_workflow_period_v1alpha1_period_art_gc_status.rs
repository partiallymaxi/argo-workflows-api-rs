...
/// IoPeriodArgoprojPeriodWorkflowPeriodV1alpha1PeriodArtGcStatus : ArtGCStatus maintains state related to ArtifactGC
#[derive(Clone, Default, Debug, PartialEq, Serialize, Deserialize)]
pub struct IoPeriodArgoprojPeriodWorkflowPeriodV1alpha1PeriodArtGcStatus {
...
impl IoPeriodArgoprojPeriodWorkflowPeriodV1alpha1PeriodArtGcStatus {
    /// ArtGCStatus maintains state related to ArtifactGC
    pub fn new() -> IoPeriodArgoprojPeriodWorkflowPeriodV1alpha1PeriodArtGcStatus {
