...
/// IoPeriodArgoprojPeriodWorkflowPeriodV1alpha1PeriodHdfsArtifactRepository : HDFSArtifactRepository defines the controller configuration for an HDFS artifact repository
#[derive(Clone, Default, Debug, PartialEq, Serialize, Deserialize)]
pub struct IoPeriodArgoprojPeriodWorkflowPeriodV1alpha1PeriodHdfsArtifactRepository {
...
impl IoPeriodArgoprojPeriodWorkflowPeriodV1alpha1PeriodHdfsArtifactRepository {
    /// HDFSArtifactRepository defines the controller configuration for an HDFS artifact repository
    pub fn new() -> IoPeriodArgoprojPeriodWorkflowPeriodV1alpha1PeriodHdfsArtifactRepository {
