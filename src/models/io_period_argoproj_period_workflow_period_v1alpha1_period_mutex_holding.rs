...
/// IoPeriodArgoprojPeriodWorkflowPeriodV1alpha1PeriodMutexHolding : MutexHolding describes the mutex and the object which is holding it.
#[derive(Clone, Default, Debug, PartialEq, Serialize, Deserialize)]
pub struct IoPeriodArgoprojPeriodWorkflowPeriodV1alpha1PeriodMutexHolding {
...
impl IoPeriodArgoprojPeriodWorkflowPeriodV1alpha1PeriodMutexHolding {
    /// MutexHolding describes the mutex and the object which is holding it.
    pub fn new() -> IoPeriodArgoprojPeriodWorkflowPeriodV1alpha1PeriodMutexHolding {
