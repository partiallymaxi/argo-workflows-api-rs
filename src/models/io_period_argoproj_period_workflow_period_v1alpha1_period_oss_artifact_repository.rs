...
/// IoPeriodArgoprojPeriodWorkflowPeriodV1alpha1PeriodOssArtifactRepository : OSSArtifactRepository defines the controller configuration for an OSS artifact repository
#[derive(Clone, Default, Debug, PartialEq, Serialize, Deserialize)]
pub struct IoPeriodArgoprojPeriodWorkflowPeriodV1alpha1PeriodOssArtifactRepository {
...
impl IoPeriodArgoprojPeriodWorkflowPeriodV1alpha1PeriodOssArtifactRepository {
    /// OSSArtifactRepository defines the controller configuration for an OSS artifact repository
    pub fn new() -> IoPeriodArgoprojPeriodWorkflowPeriodV1alpha1PeriodOssArtifactRepository {
