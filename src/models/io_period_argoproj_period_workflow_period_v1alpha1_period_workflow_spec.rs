...
/// IoPeriodArgoprojPeriodWorkflowPeriodV1alpha1PeriodWorkflowSpec : WorkflowSpec is the specification of a Workflow.
#[derive(Clone, Default, Debug, PartialEq, Serialize, Deserialize)]
pub struct IoPeriodArgoprojPeriodWorkflowPeriodV1alpha1PeriodWorkflowSpec {
    ...
    pub artifact_gc: Option<Box<models::IoPeriodArgoprojPeriodWorkflowPeriodV1alpha1PeriodWorkflowLevelArtifactGc>>,
    #[serde(rename = "artifactRepositoryRef", skip_serializing_if = "Option::is_none")]
    pub artifact_repository_ref: Option<Box<models::IoPeriodArgoprojPeriodWorkflowPeriodV1alpha1PeriodArtifactRepositoryRef>>,
    ...
    pub dns_config: Option<Box<models::IoPeriodK8sPeriodApiPeriodCorePeriodV1PeriodPodDnsConfig>>,
    ...
    pub pod_disruption_budget: Option<Box<models::IoPeriodK8sPeriodApiPeriodPolicyPeriodV1PeriodPodDisruptionBudgetSpec>>,
    #[serde(rename = "podGC", skip_serializing_if = "Option::is_none")]
    pub pod_gc: Option<Box<models::IoPeriodArgoprojPeriodWorkflowPeriodV1alpha1PeriodPodGc>>,
    ...
    pub template_defaults: Option<Box<models::IoPeriodArgoprojPeriodWorkflowPeriodV1alpha1PeriodTemplate>>,
    /// Templates is a list of workflow templates used in a workflow
    #[serde(rename = "templates", skip_serializing_if = "Option::is_none")]
    pub templates: Option<Vec<models::IoPeriodArgoprojPeriodWorkflowPeriodV1alpha1PeriodTemplate>>,
    ...
    pub ttl_strategy: Option<Box<models::IoPeriodArgoprojPeriodWorkflowPeriodV1alpha1PeriodTtlStrategy>>,
    #[serde(rename = "volumeClaimGC", skip_serializing_if = "Option::is_none")]
    pub volume_claim_gc: Option<Box<models::IoPeriodArgoprojPeriodWorkflowPeriodV1alpha1PeriodVolumeClaimGc>>,
    /// VolumeClaimTemplates is a list of claims that containers are allowed to reference. The Workflow controller will create the claims at the beginning of the workflow and delete the claims upon completion of the workflow
    #[serde(rename = "volumeClaimTemplates", skip_serializing_if = "Option::is_none")]
    pub volume_claim_templates: Option<Vec<models::IoPeriodK8sPeriodApiPeriodCorePeriodV1PeriodPersistentVolumeClaim>>,
    ...
    pub workflow_metadata: Option<Box<models::IoPeriodArgoprojPeriodWorkflowPeriodV1alpha1PeriodWorkflowMetadata>>,
    #[serde(rename = "workflowTemplateRef", skip_serializing_if = "Option::is_none")]
    pub workflow_template_ref: Option<Box<models::IoPeriodArgoprojPeriodWorkflowPeriodV1alpha1PeriodWorkflowTemplateRef>>,
}

impl IoPeriodArgoprojPeriodWorkflowPeriodV1alpha1PeriodWorkflowSpec {
    /// WorkflowSpec is the specification of a Workflow.
    pub fn new() -> IoPeriodArgoprojPeriodWorkflowPeriodV1alpha1PeriodWorkflowSpec {
