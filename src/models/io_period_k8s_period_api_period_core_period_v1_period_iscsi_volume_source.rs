...
/// IoPeriodK8sPeriodApiPeriodCorePeriodV1PeriodIscsiVolumeSource : Represents an ISCSI disk. ISCSI volumes can only be mounted as read/write once. ISCSI volumes support ownership management and SELinux relabeling.
#[derive(Clone, Default, Debug, PartialEq, Serialize, Deserialize)]
pub struct IoPeriodK8sPeriodApiPeriodCorePeriodV1PeriodIscsiVolumeSource {
...
impl IoPeriodK8sPeriodApiPeriodCorePeriodV1PeriodIscsiVolumeSource {
    /// Represents an ISCSI disk. ISCSI volumes can only be mounted as read/write once. ISCSI volumes support ownership management and SELinux relabeling.
    pub fn new(iqn: String, lun: i32, target_portal: String) -> IoPeriodK8sPeriodApiPeriodCorePeriodV1PeriodIscsiVolumeSource {
