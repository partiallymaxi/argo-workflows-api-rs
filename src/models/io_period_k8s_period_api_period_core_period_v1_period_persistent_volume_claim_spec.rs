...
pub struct IoPeriodK8sPeriodApiPeriodCorePeriodV1PeriodPersistentVolumeClaimSpec {
    ...
    pub data_source: Option<Box<models::IoPeriodK8sPeriodApiPeriodCorePeriodV1PeriodTypedLocalObjectReference>>,
    #[serde(rename = "dataSourceRef", skip_serializing_if = "Option::is_none")]
    pub data_source_ref: Option<Box<models::IoPeriodK8sPeriodApiPeriodCorePeriodV1PeriodTypedObjectReference>>,
    #[serde(rename = "resources", skip_serializing_if = "Option::is_none")]
    pub resources: Option<Box<models::IoPeriodK8sPeriodApiPeriodCorePeriodV1PeriodVolumeResourceRequirements>>,
